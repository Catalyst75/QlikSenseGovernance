              ...
              function getBookmarksDetails(bookmarks_list){
                ...
                app.getBookmark(first_bookmark).then(function(bkmk){
                  ...
                  .then(function(data){
                    ...
                    fs.writeFile('AppStructures/'+config_app.appname+'_Bookmarks_'+first_bookmark+'.xml', xml_library_bookmarks, function(err) {
                      if (err) throw err;
                      console.log('   '+config_app.appname+'_Bookmarks_'+first_bookmark+'.xml file saved');
                      console.log();
