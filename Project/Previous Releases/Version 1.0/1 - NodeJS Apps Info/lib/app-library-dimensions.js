                ...
                app.getDimension(first_dimension).then(function(dim){
                  ...
                  .then(function(dim_layout){
                    ...
                    .then(function(data){
                      ...
                      fs.writeFile('AppStructures/'+config_app.appname+'_LibraryDimensions_'+first_dimension+'.xml', xml_library_dimensions, function(err) {
                        if (err) throw err;
                        console.log('   '+config_app.appname+'_LibraryDimensions_'+first_dimension+'.xml file saved');
                        console.log();
