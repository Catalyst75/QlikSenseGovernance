                      ...
                      function getSheetObjects(objects_list){
                        ...
                        sht.getChild(first_object).then(function(obj){
                          obj.getFullPropertyTree().then(function(obj_full_props){
                            ...
                            fs.writeFile('AppStructures/'+config_app.appname+'_SheetObject_'+first_sheet+'_'+first_object+'.xml', xml_sheet_object, function(err) {
                              if (err) throw err;
                              console.log(' │  '+config_app.appname+'_SheetObject_'+first_sheet+'_'+first_object+'.xml file saved');
                              console.log(' │  ');
                              ...
                              if(objects_list.length>0)
                                ...
                                fs.writeFile('AppStructures/'+config_app.appname+'_Sheet_'+first_sheet+'.xml', xml_sheet, function(err) {
                                  if (err) throw err;
                                  console.log(' - '+config_app.appname+'_Sheet_'+first_sheet+'.xml file saved');
                                  console.log('- - - - - - - - - - - - - - - - - - - ');
